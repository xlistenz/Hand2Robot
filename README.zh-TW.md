...
- 右手控制底座、手臂高度與前伸距離，以及手腕俯仰和翻轉；左手捏合可關閉夾爪。只有一隻手時，該手也能控制夾爪。
- Objects 提供方塊、球體、圓柱、圓環及長方體，可捏住搬動並轉動手腕改變物件方向。
...
| Robot Arm | 使用雙手控制參考 SO-ARM101 關節配置的虛擬手臂；顯示即時關節角度及操作選項。 |
| Objects | 在 3D 工作台捏住物件移動，轉動手腕即可旋轉物件。 |
| Gesture Lab | 查看手勢信心度、追蹤狀態及最近的手勢歷史。 |
| Settings | 設定攝影機骨架疊圖與鏡像預覽；機械手臂的效能選項位於 Robot Arm 模式。 |

## 機械手臂控制

右手左右移動可旋轉底座，上下移動可調整手臂高度，靠近或遠離攝影機可改變手臂前伸距離。轉動右手手腕可控制手腕俯仰與翻轉。左手拇指和食指捏合會關閉夾爪；只有一隻手時，該手同時控制手臂和夾爪。
